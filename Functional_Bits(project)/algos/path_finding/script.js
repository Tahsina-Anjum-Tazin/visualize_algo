...
let startingPointX = 11;
let startingPointY = 18;
let endingPointX = 11;
let endingPointY = 35;

let speedSlider = document.getElementById('speedSlider');
speedSlider.style.backgroundColor='black';
let speed =140- speedSlider.value;
//let speed = 30;
...
let animate = async (nodesToAnimate, speed) => {
  for (let i = 0; i < nodesToAnimate.length; i++) {
    speed =140- speedSlider.value;
    playNote(432);
